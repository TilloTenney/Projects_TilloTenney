...
**Disclaimer:**
The dataset used in this analysis is based on the Delhi 2023 Air Quality Index (AQI) dataset. For the purpose of clarity and better understanding, it has been renamed to "Trichy" in this documentation. The dataset itself remains unaltered.
